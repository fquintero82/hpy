...
def test2():
    ...
    def fun(t,q):
        ...
        #dq/dt[0]=chanel1= invtau * pow(q, lambda_1) * dq/dt[0]
        #dq/dt[1]=chanel2= invtau * pow(q, lambda_1) * dq/dt[1]
        #dq/dt[2]=chanel3= invtau * pow(q, lambda_1) * dq/dt[2] + dq/dt[0] + dq/dt[1]
...
def test3():
    ...
    res = solve_ivp(fun,t_span=(0,100),y0=[100,110,100],args=args2)
    plt.plot(res['t'],res['y'][0])
    plt.plot(res['t'],res['y'][1])
    plt.plot(res['t'],res['y'][2])
    plt.show()
